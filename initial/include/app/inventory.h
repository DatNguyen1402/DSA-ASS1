...
List1D<T>::List1D(int num_elements)
{
    ...
    for (int i = 0; i < num_elements; i++){
        pList->add(0); // initialize with default value = 0
    }
}
...
{
    // TODO
    attributesMatrix.add(attributes);
...
{
    // TODO
    List1D<string> result = List1D<string>();
